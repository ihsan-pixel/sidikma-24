                ...
                <div class="card-body">
                    <form action="/admin/add" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label" for="nama_lengkap">Nama Users</label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label" for="email">Email Admin Madrasah/Sekolah</label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="role" id="role" required>
                                        ...
                                        <option value="4">Pengurus LP. Ma'arif NU PCNU Gunungkidul</option>
                                    </select>
                                </div>
                            </div>
                            {{--<div class="col-md-6">

                ...
                <tbody>
                    ...
                    @foreach ($tenagapendidik as $tp)
                        <tr>
                            ...
                            <td>
                                <a href="/siswa/edit/{{ $tp->id }}" type="button" class="btn btn-success">Edit</a>
                                <button href="/tenaga/open{{ $tp->id }}" type="button" class="btn btn-danger">View</button>
                            @if (request()->user()->role == 1)
                                <button type="button" class="btn btn-danger" data-bs-toggle="modal"

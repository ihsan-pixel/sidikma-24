   ...
   <div class="card table-responsive">
        <div class="card-header d-flex justify-content-between align-items-center">
            <div class="user-profile-header-banner" style="margin-bottom: 0%;">
                <img src="{{ asset('') }}storage/images/logo/logo maarif.png"
                    ...
                    <div class="card-body">
                        <table class="table table-striped">
                            <tbody>   
                                <tr>
                                    <td>Nama Lembaga</td>
                                    <td>: Lembaga Pendidikan Ma'arif NU PCNU Kabupaten Gunungkidul</td>
                                </tr>
                                <tr>
                                    <td>Alamat</td>
                                    <td>: Jl. Tentara Pelajar, Trimulyo I, Kepek, Wonosari, Gunungkidul, Yogyakarta 55813 </span></td>
                                </tr>
                                <tr>
                                    <td>Email</td>
                                    <td>: maarifgunungkidul@gmail.com</td>
                                </tr>
                                <tr>
                                    <td>Instagram</td>
                                    <td>: @lpm_gunungkidul</td>
                                </tr>
                                <tr>
                                    <td>Nomor Telepon/Whatsapp</td>
                                    <td>: 088215927491 (Admin)</td>
                                </tr>
                        </tbody>
                    </table>
                </div>

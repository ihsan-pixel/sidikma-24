...
@section('content')
    <div class="card table-responsive">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="/tenagapendidikAdd" type="button" class="btn rounded-pill btn-primary justify-content-end"
                ...
                <tbody>
                    ...
                    @foreach ($tenaga_pendidik as $tp)
                        <tr>
                            ...
                            <td width="auto">{{ $tp->nis }}</td>
                            <td width="auto">{{ $tp->nama_lengkap }}</td>
                            <td width="auto">{{ $tp->email }}</td>
                            <td width="auto">{{ $tp->nama_kelas }}</td>
                            <td width="auto">{{ $tp->nama_jurusan }}</td>
                            <td width="auto">
